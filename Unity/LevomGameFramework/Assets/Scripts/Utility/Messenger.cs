...
#pragma warning restore 0414
    ...
    static public void AddListener<T, U, V, Y>(string eventType, Callback<T, U, V, Y> handler)
    {
        OnListenerAdding(eventType, handler);
    ...
    static public void RemoveListener<T, U, V, Y>(string eventType, Callback<T, U, V, Y> handler)
    {
        if (eventTable.ContainsKey(eventType))
        {
            OnListenerRemoving(eventType, handler);
